  ...
  return (
    <div>
        <Form className='add-edit-user-form' onSubmit={formik.handleSubmit}> 
            ...
            <Form.Input name="first_name" placeholder="Nombre de usuario" value={formik.values.first_name} onChange={formik.handleChange} error={formik.errors.first_name} />
            ...
            <Form.Input name="password" type="password" placeholder="Contrasena" value={formik.values.password} onChange={formik.handleChange} error={formik.errors.password} />
